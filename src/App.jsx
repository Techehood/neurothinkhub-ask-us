            ...
            <>
              <div style={S.chatContainer}>
                ...
                <div style={S.messagesArea}>
                  ...
                  {atLimit && !loading && (
                    <div style={{ textAlign: 'center', padding: '12px', background: '#F8E6D8', borderRadius: '12px', fontSize: '13px', color: '#594a66' }}>
                      That is the end of this session. Click "New conversation" to continue.
                    </div>
                  )}
